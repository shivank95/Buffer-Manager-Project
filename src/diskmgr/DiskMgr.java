...
public class DiskMgr implements GlobalConst {
  ...
  public void openDB( String fname)
    ...
    //System.out.println("Num PagesSTART: " + firstpg.getNumDBPages());
 ...
 * @throws ChainException 
  ...
  public void openDB( String fname, int num_pgs)
    ...
    //System.out.println("num_pages1: " + num_pages);
  ...
  public  void read_page(PageId pageno, Page apage)
    throws InvalidPageNumberException, 
	  ...
	  //System.out.println("NUMPAGES: " + num_pages + "PageNo.pid: " + pageno.pid);
	  //num_pages = 1;
